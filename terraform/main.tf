...
# ==========================================================
# IAM: Allow Karpenter Controller to Pass Role + Add to InstanceProfile
# ==========================================================
    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/${module.eks.cluster_name}-karpenter"
      }
    ]
  })
}
